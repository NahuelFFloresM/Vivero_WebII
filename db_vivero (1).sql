...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2020 a las 20:19:20
...
(3, 'Echeveria Shaviana', 350, 250, 'Es una planta de roseta grande con hojas terminadas en punta, las hojas son delicadamente rizadas.\r\nLa roseta tiene un color gris mas claro en su centro y los bordes de las hojas mas viejas tienen un borde purpura.', 2, 1),
...
(12, 'Macetero de Colores', 3000, 150, 'Estos maceteros son ideales para decorar rincones y jugar con las distintas alturas. Combinalos con otras macetas de distintos diámetros y tamaños. Elegí el color que mas vaya con vos, o tu espacio.\r\n\r\nEstán hechos a mano, son de hierro, y tanto el pie como la maceta están pintados a horno con pintura epoxi micro texturada mate. La maceta posee drenaje.', 5, 1),
...
(14, 'Sustrato para Plantas de interiores', 350, 100, 'ste sustrato aumenta la retención de nutrientes.\r\nEvita cambios en el pH. Favorece la aireación y respiración de las raíces. Evita la compactación favoreciendo el desarrollo de raíces. Evita cambios bruscos de temperatura.\r\n* Presentación 10 lts.', 6, 0),
...
(18, 'Hummus de lombriz Liquido', 750, 0, 'Con el Humus de lombriz liquido rebajado en agua haces un riego normal, y le aportas los nutrientes que tu planta necesita.\r\n\r\nFertilizante Orgánico \r\n\r\nPresentación Liquido: 1L (para rebajar con agua)', 8, 0);
